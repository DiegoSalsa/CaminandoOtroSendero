...
No existe un archivo compartido que genere el footer publicado. La excepción visual autorizada se materializará exclusivamente insertando `<a href="/pages/recursos">Centro de conocimiento</a>` antes del cierre del `nav` del footer en las 16 páginas con ese componente. No se autoriza una edición general de esos archivos. El verificador retira una sola inserción exacta, comprueba su ubicación y exige el SHA-256 original de todos los bytes restantes. Así se protege también el header que comparte archivo con el footer. El manifiesto enumera los archivos y esta excepción por fragmento, no por archivo completo.
